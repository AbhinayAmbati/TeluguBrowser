    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          >
            <h1 className="text-3xl font-light text-gray-800 mb-2">Privacy & Settings</h1>
            <p className="text-gray-500">Customize your browsing experience and privacy preferences</p>
          </motion.div>
